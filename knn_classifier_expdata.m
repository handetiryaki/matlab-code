function [ z ] = knn_classifier_expdata(hastfidfweighting,feature_size,feature_selection_method,dataset_type)
...
result_fpath=strcat('D:\googledriveakuysal\academic\kod\term_weighting_experiments\',resfoldername,'\knnres.txt');
