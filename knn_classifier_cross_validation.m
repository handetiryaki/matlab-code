function [ z ] = knn_classifier_cross_validation(dataset_type,tokenization_type,feature_selection_method,usespecialfeatures,usestopwordremoval,uselowercase,usestemming,hastfidfweighting,feature_size,currentpart,crossvaltotal)
...
if (hastfidfweighting==1)
    result_fpath=strcat('D:\googledriveakuysal\academic\kod\docentlik_baslica_eser_tc\',resfoldername,'\',num2str(crossvaltotal),num2str(currentpart),'knnres_with_tfidf.txt');
else
    result_fpath=strcat('D:\googledriveakuysal\academic\kod\docentlik_baslica_eser_tc\',resfoldername,'\',num2str(crossvaltotal),num2str(currentpart),'knnres_without_tfidf.txt');
end
...
destination_fpath=strcat('D:\googledriveakuysal\academic\kod\docentlik_baslica_eser_tc\',resfoldername,'\');
eval(['save ', strcat(destination_fpath,'overall_result_table.mat'), '  micro_F1 p_value r_value macro_F1'])
